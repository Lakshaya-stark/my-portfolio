...
export default function HUDLoader({ onFinish }) {
  ...
  return (
    ...
    >
      {/* AI radial glow */}
      <div className="absolute w-[500px] h-[500px] bg-cyan-400/10 blur-[120px] rounded-full"></div>
      ...
      <div className="absolute text-cyan-300 font-mono text-xl tracking-widest">
